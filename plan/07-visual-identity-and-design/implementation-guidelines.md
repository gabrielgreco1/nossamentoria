...
- Use reusable React components for glass surfaces, buttons, cards, and app shell.
...
- Maintain readable contrast on dark and video backgrounds.
...
- Do not hard-code one-off glass CSS in every screen.
